...
export default function Navigation(props: any){
    ...
    return (
        <div className="w-full py-[30px] px-[300px] laptopM:px-[100px] laptopL:px-[100px] screen-1670px:px-[200px] screen-1170px:px-[300px] laptopS:px-[50px] laptop:px-[50px] tabletM:px-[30px] mobileL:px-[20px] flex items-center justify-between bg-gradient-to-b from-white to-transparent fixed top-0 z-[50]">
            <m.div>
                <Link href="/" className="">
            ...
            <m.div className="flex items-center tabletM:hidden">
                ...
                <div className="w-fit block mr-[70px]">
                    ...
                    { router.pathname.startsWith('/timeline') ? <motion.div layoutId='underline' className="w-full h-[1px] bg-[#333333]"></motion.div> : <div className="h-[1px] bg-transparent"></div> }
                </div>

                <div className="w-fit block mr-[70px]">
                    <Link href="/works" className="text-[14px]">Works</Link>
                    { router.pathname.startsWith('/works') ? <motion.div layoutId='underline' className="w-full h-[1px] bg-[#333333]"></motion.div> : <div className="h-[1px] bg-transparent"></div> }
                </div>
