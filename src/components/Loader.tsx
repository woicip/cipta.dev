...
export default function Loader(props: any){
    ...
    return (
        <AnimatePresence>
            ...
            <m.div initial="hidden" animate="show" exit="exit" variants={variants} 
                ...
                <m.div variants={item} className="z-[90] absolute">
                    <Image src={logo} alt="logo" />
                    <m.h1 layoutId="headline" className="mt-[20px] text-[35px] tabletL:text-[30px]">Passionate Full Stack <br/> Developer.</m.h1>
                </m.div>
                ...
                <m.div variants={item} className="absolute top-[-40px] right-[-10px] laptopL:top-[-90px] laptopM:right-[-100px] laptopM:top-[-250px] laptopS:right-[-250px] mobileL:right-[-430px] mobileS:right-[-500px]">
                    <Image src={wallpaper} alt="img" className="w-[600px]  rounded-[10px]" />
                </m.div>

                <m.div variants={item} className="absolute bottom-[-200px] left-[180px] laptopM:left-[100px] laptopM:bottom-[-320px] laptopS:left-[-80px] tabletL:bottom-[-250px] mobileL:left-[-380px] mobileS:left-[-420px]">
