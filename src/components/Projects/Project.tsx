    ...
    return (
        <motion.div transition={{ duration: 1.5, ease: [0.6, 0.01, -0.05, 0.9] }} layoutId={layoutId}>
            <Link href={link} className="relative cursor-pointer">
                ...
                <motion.div className="h-[450px] laptopM:h-[400px] laptopL:h-[400px] laptopS:h-[350px] screen-1170px:h-[390px] laptop:h-[550px] tabletL:h-[450px] tabletM:h-[300px] mobileL:h-[250px] mobileS:h-[200px] rounded-[30px] tabletM:rounded-[20px] overflow-hidden bg-[#D9D9D9]">
                    <motion.div 
